...
<div class='anh-sanpham-moi'><a href="/nham-nhi-tet-tan-suu-2021"><img class="img-responsive" data-src="{{ asset('images/'.$book->img) }}" src="{{ asset('images/'.$book->img) }}" width="800" height="813" alt=""/><noscript><img
...
"><a href="/nham-nhi-tet-tan-suu-2021">{{ $book->name }}</a></div></div>
